...
public interface INotificationService
{
    ...
    Task<NotificationDto> CreateAsync(Guid userId, Guid? taskId, TodoApp.Domain.Enums.NotificationType type, string message, CancellationToken cancellationToken = default);
